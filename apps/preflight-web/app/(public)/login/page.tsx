...
function LoginForm() {
  ...
  const handleOAuthSignIn = async (provider: "oauth_google" | "oauth_github") => {
    ...
    try {
      ...
      setError("Failed to start OAuth sign in");
    }
  };
...
function LoginFormFallback() {
  return (
    <div className="bg-zinc-900/50 backdrop-blur-xl rounded-md border border-zinc-800 p-6 animate-pulse">
      <div className="text-center mb-8">
    ...
    <div className="min-h-screen flex items-center justify-center bg-zinc-950">
      ...
      <div className="relative z-10 max-w-md w-full px-4">
        ...
        <p className="text-center text-sm text-zinc-400 mt-6">
          ...
          <a href="/sign-up" className="text-zinc-100 hover:underline">
            Sign up
          </a>
        </p>
      </div>
